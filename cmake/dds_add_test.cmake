...
function(dds_configure_test_files)
  ...
  foreach(script ${test_scripts})
    ...
    string(REGEX REPLACE "use Env *\\(DDS_ROOT\\);" "$DDS_ROOT=\"$<TARGET_FILE_DIR:OpenDDS_Dcps>/..\";" RUN_TEST_CONTENT "${RUN_TEST_CONTENT}")
    string(REGEX REPLACE "use Env *\\(ACE_ROOT\\);" "$ACE_ROOT=\"${ACE_ROOT}\";" RUN_TEST_CONTENT "${RUN_TEST_CONTENT}")
    string(REPLACE "\$ENV{DDS_ROOT}" "$<TARGET_FILE_DIR:OpenDDS_Dcps>/.." RUN_TEST_CONTENT "${RUN_TEST_CONTENT}")
