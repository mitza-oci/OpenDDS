...
public class ExampleSubscriber {
  ...
  public static void main(String[] args) {
    ...
    DomainParticipantFactory dpf = TheParticipantFactory.WithArgs(new org.omg.CORBA.StringSeqHolder(args));
    if (dpf == null) {
    ...
    DeviceListTypeSupportImpl ts = new DeviceListTypeSupportImpl();
    ...
    System.out.println("Ready for data samples, waiting 1 min");
    try {
