...
if (HOSTTOOLS_ONLY)
  ...
  if (OPENDDS_SAFETY_PROFILE)
    if (NOT (OPENDDS_SAFETY_PROFILE STREQUAL "BASE" OR OPENDDS_SAFETY_PROFILE STREQUAL "EXTENDED"))
      message(FATAL_ERROR "OPENDDS_SAFETY_PROFILE must be either BASE or EXTENDED")
    endif()
